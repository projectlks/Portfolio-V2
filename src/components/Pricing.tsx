...
export const FeatureListItem = ({
  ...
  <li
    className={`flex items-center space-x-[6px] text-[16px] font-medium satoshi  ${black ? "text-gray-100" : "text-[#3d3d3d]"} `}>
...
export default function Pricing() {
  return (
    <div
      id="pricing"
      className="w-[90%] flex flex-col space-y-[26px] md:space-y-[35px] mx-auto sm:max-w-[600px] md:max-w-[740px] xl:max-w-[1102px]">
      <div className="flex flex-col space-y-2">
        <p className="xl:text-[44px] text-[37px] cursor-default select-none">
          Pricing
        </p>
        <p className="text-[18px] cursor-default font-medium leading-[1.3em] text-[#6e6e6e] satoshi">
          Elevate your brand with our in-house design expert who brings over 2
      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-2">
        ...
        <div className="rounded-[24px] p-2 bg-[#e8e8e8] h-fit">
          <div className="p-5 flex flex-col space-y-[16px] shadow-2xl shadow-black/5 bg-[#fcfcfc] rounded-[17px]">
            ...
            <p className="text-[15px] cursor-default satoshi font-medium leading-[1.2em] text-[#8c8c8c]">
              Capture attention and drive conversions effectively. Meticulously
              crafted design to impact your audience.
            </p>
            ...
            <ul className="flex flex-col space-y-[12px]">
              ...
              />
              <FeatureListItem
                icon={<PencilIcon className="w-[16px] h-[16px]" />}
                text="Design and Build"
              />
              <FeatureListItem
                icon={<RectangleStackIcon className="w-[16px] h-[16px]" />}
                text="Unlimited revisions"
              />
              <FeatureListItem
                icon={<Squares2X2Icon className="w-[16px] h-[16px]" />}
                text="Responsive design"
              />
              <FeatureListItem
                icon={<ChatBubbleOvalLeftIcon className="w-[16px] h-[16px]" />}
                text="Slack/Discord communication"
              />
            </ul>
            <div className="pt-2">
              <a href="">
                <button className="w-full cursor-pointer rounded-full bg-gray-900 hover:bg-gray-950 h-[38px] text-gray-100 flex justify-center items-center">
                  <p className="leading-none bold">Get Landing Page</p>
                </button>
              </a>
            </div>
          </div>
        ...
        <div className="rounded-[24px] p-2 bg-[#e8e8e8]">
          <div className="p-5 flex flex-col space-y-[16px] shadow-2xl shadow-black/5 bg-[#fcfcfc] rounded-[17px]">
            ...
            <div className="w-[41px] h-auto aspect-square rounded bg-[#f5f5f5] flex justify-center items-center">
              <svg
                ...
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  d="M2.25 7.125C2.25 6.504 2.754 6 3.375 6h6c.621 0 1.125.504 1.125 1.125v3.75c0 .621-.504 1.125-1.125 1.125h-6a1.125 1.125 0 0 1-1.125-1.125v-3.75ZM14.25 8.625c0-.621.504-1.125 1.125-1.125h5.25c.621 0 1.125.504 1.125 1.125v8.25c0 .621-.504 1.125-1.125 1.125h-5.25a1.125 1.125 0 0 1-1.125-1.125v-8.25ZM3.75 16.125c0-.621.504-1.125.504-1.125h5.25c.621 0 1.125.504 1.125 1.125v2.25c0 .621-.504 1.125-1.125 1.125h-5.25a1.125 1.125 0 0 1-1.125-1.125v-2.25Z"
                />
              </svg>
            </div>
            {/* title */}
            <div className="flex flex-row items-center justify-between space-y-1">
              <p className="text-[20px] satoshi cursor-default font-bold">
                Full Website
              </p>
              <div className="flex items-center space-x-2">
                <div className="flex flex-col justify-center items-center border rounded border-gray-300 h-[21px] px-2">
                  <p className="text-xs font-medium cursor-default text-[#949494]">
                    Starting at
                  </p>
                </div>
                <p className="text-[18px] satoshi cursor-default font-bold">
                  3,000K +
                </p>
              </div>
            </div>
            ...
            <ul className="flex flex-col space-y-[12px]">
              <FeatureListItem
                icon={<DocumentDuplicateIcon className="w-[16px] h-[16px]" />}
                text="Multi page"
              />
              <FeatureListItem
                icon={<PencilIcon className="w-[16px] h-[16px]" />}
              ...
              />
              <FeatureListItem
                icon={<CodeBracketIcon className="w-[16px] h-[16px]" />}
            ...
            <div className="pt-2">
              <a href="">
                <button className="w-full cursor-pointer rounded-full bg-gray-900 hover:bg-gray-950 h-[38px] text-gray-100 flex justify-center items-center">
                  <p className="leading-none bold">Get Full Website</p>
                </button>
              </a>
            </div>
          </div>
        ...
        <div className="rounded-[24px] p-2 bg-[#e8e8e8] h-fit">
          <div className="p-5 flex flex-col space-y-[16px] shadow-2xl shadow-black/5 bg-[#212121] rounded-[17px]">
            ...
            {/* title */}
            <div className="flex flex-row items-center justify-between space-y-1">
              <p className="text-[20px] satoshi cursor-default font-bold text-gray-100">
                Custom
              </p>
            </div>
            ...
            <ul className="flex flex-col space-y-[12px]">
              <FeatureListItem
                icon={
                  <GlobeAltIcon className="w-[16px] h-[16px] text-gray-200" />
                }
                text="Web apps"
                black
              />
              <FeatureListItem
                icon={
                  <ComputerDesktopIcon className="w-[16px] h-[16px] text-gray-200" />
                }
                text="Desktop apps"
                black
              />
              <FeatureListItem
                icon={
                  <DevicePhoneMobileIcon className="w-[16px] h-[16px] text-gray-200" />
                }
                text="Mobile apps"
                black
              />
            ...
            <div className="pt-2">
              <a href="">
                <button className="w-full cursor-pointer rounded-full bg-gray-100 hover:bg-gray-200 h-[38px] text-gray-900 flex justify-center items-center">
                  <p className="leading-none bold">Request Custom</p>
                </button>
              </a>
            </div>
          </div>
